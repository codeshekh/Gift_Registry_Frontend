...
{selectedRegistry && (
  <div className="mt-8">
    <div className="flex justify-between items-center mb-4">
      <h2 className="text-2xl font-bold">Gifts for {selectedRegistry.name}</h2>
      <Dialog open={isAddGiftOpen} onOpenChange={setIsAddGiftOpen}>
        <DialogTrigger asChild>
          <Button className="ml-auto"> {/* Align button to the right */}
            <PlusIcon className="mr-2 h-4 w-4" /> Add Gift
          </Button>
        </DialogTrigger>
        
        {/* Place DialogContent inside the Dialog component */}
        <DialogContent className="bg-black text-white">
          <DialogHeader>
